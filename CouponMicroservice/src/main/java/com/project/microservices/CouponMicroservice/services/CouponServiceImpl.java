package com.project.microservices.CouponMicroservice.services;

import com.project.microservices.CouponMicroservice.daos.CouponDao;
import com.project.microservices.CouponMicroservice.entities.Coupon;
import com.project.microservices.CouponMicroservice.entities.JsonResponseBody;
...
public class CouponServiceImpl implements  CouponService{
    ...
    private List<LinkedHashMap> getAccountsGivenJwt(String jwt){
        ...
        List accounts = (List) responseEntity.getBody().getResponse();
        return accounts;
